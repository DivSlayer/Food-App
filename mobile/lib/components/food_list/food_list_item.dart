...
class FoodListItem extends StatelessWidget {
  const FoodListItem({super.key, required this.food, this.eliminated = false});

  final bool eliminated;
  final FoodModel food;

  int getMinPrice() {
    if (food.selectedSize != null) {
      return food.selectedSize!.price;
    }
    int price =
        food.sizes.length > 1
            ? food.sizes[1].price
            : food.sizes.isNotEmpty
            ? food.sizes[0].price
            : 0;
    return price;
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: eliminated ? redColor.withOpacity(0.5) : borderColor.withOpacity(0.5),
          width: 1,
        ),
      ),
      child: Row(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.displayMedium!.copyWith(fontSize: dimmension(18, context)),
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(dimmension(5, context)),
                          child: Image.network(food.restaurantInfo.logo),
                        ),
                      ),
                    ],
                  ),
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        '${priceFormatter(getMinPrice())} تومان',
                        textDirection: TextDirection.rtl,
                        style: Theme.of(
                          context,
                ...
                eliminated
                    ? Text(
                      'این آیتم موجود نیست و از لیست شما حذف خواهد شد!',
                      maxLines: 2,
                      textDirection: TextDirection.rtl,
                      style: Theme.of(context).textTheme.displaySmall!.copyWith(color: redColor),
                    )
                    : Container(),
              ],
            ),
